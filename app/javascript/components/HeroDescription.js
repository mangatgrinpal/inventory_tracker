		...
		<Fragment>
			<Row className='justify-content-start text-center hero-description pt-5 mt-5'>
				<Col xs={12} md={4}>
					...
					<p className='item-name'>Easily add restaurants to track their inventories.</p>
				</Col>
			</Row>
			<Row className='justify-content-center text-center hero-description'>
				<Col xs={12} md={4}>
					<h6 className='section-name'>Add your items</h6>
					<p className='item-name'>Add items to your restaurants, organized in categories to find them quickly.</p>
				</Col>
			</Row>
			<Row className='justify-content-end text-center hero-description'>
				<Col xs={12} md={4}>
					<h6 className='section-name'>Start tracking</h6>
					<p className='item-name'>Keep track of the quantities you need, on your computer or on the go.</p>
				</Col>
			</Row>
		</Fragment>
	)
